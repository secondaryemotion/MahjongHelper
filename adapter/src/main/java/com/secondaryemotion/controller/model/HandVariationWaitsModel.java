...
public class HandVariationWaitsModel {
    ...
    public HandVariationWaitsModel(){};

    public HandVariationWaitsModel(int[][] manWaits, int[][] pinWaits, int[][] souWaits, int[][] honorWaits) {
